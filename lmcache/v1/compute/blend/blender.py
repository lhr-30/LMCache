...
class LMCBlender:
    ...
    def blend_layer(
        ...
        page_stream: Optional[torch.cuda.Stream] = None,
        **kwargs,
    ):
        """
        ...
        layerwise_model_executor = self.layerwise_model.compute_layer(tokens, page_stream, **kwargs)
        kwargs["model_executor"] = layerwise_model_executor
    ...
    def blend(
        ...
        **kwargs,
        ...
        layerwise_blender = self.blend_layer(tokens, mask, page_stream, **kwargs)
...
class LMCPIEBlender:
    ...
    def process_qkv(
        ...
        **kwargs,
        ...
        edit_mode = kwargs.get("edit_mode", "insert") # can be "insert", "delete", or "replace"
        if edit_mode == "insert":
            edit_pair = kwargs.get("edit_pair", None)
    ...
    def blend_layer(
        ...
        **kwargs,
        ...
        # logger.info(f"Layerwise compute time: {compute_end - compute_start:.4f} seconds")
        # logger.info(f"Layerwise retrieve time: {retrieve_end - retrieve_time:.4f} seconds")
